...
import aboutHero from '../../assets/contact1.png';
...
function ContactsHero() {
  ...
  return (
    <div ref={ref} className="grid grid-cols-2 md:h-[80vh] h-[50vh]">
      {/* Left Column: Text */}
      <div className="bg-deep-blue flex items-center">
        <motion.p
          className="mt-[45%] px-10 md:text-6xl text-3xl font-bold text-sage"
        ...
        >
          {words.map((word, wordIndex) => (
            <motion.span
              key={wordIndex}
              style={{ display: 'inline-block', whiteSpace: 'nowrap', marginRight: '0.1' }}
            >
      ...
      <div>
        <img
          src={aboutHero}
          alt="Siman Wellness Centre Contact"
          className="md:h-[80vh] h-[50vh] object-cover w-full"
        />
      </div>
    </div>
  );
