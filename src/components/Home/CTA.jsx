...
function CTA() {
  return (
    <div className=' bg-bg flex justify-center py-20 '>
        ...
        <div className=' md:mx-5 mx-1 text-center bg-dark-green w-fit md:px-68 py-20 rounded-3xl'>
            <h1 className=' text-bg md:text-5xl text-4xl hero-phrase font-medium'>Begin Your Transformation</h1>

            <p className=' mt-5 md:text-lg text-gray-200'>Ready to grow, thrive, and achieve your goals? </p>
            <p className=' md:text-lg text-gray-200 px-1'>Let <span className=' italic'>My Soul’s Universe</span> guide you with expert coaching and support.</p>
