  ...
  return (
    <div className=' bg-bg pb-10'>
        <div className=' text-center pt-20'>
            <h1 className=' text-dark-green text-[60px] font-[500] hero-phrase'>Emotional <span className=' italic'>well-being</span> through  </h1>
            <h1 className=' text-dark-green text-[60px] font-[500] hero-phrase -mt-7'>expert guidance & transformative coaching</h1>
        ...
        <div className=' flex justify-center'>
            <button className=' bg-dark-green px-5 py-4 mt-10 rounded-lg text-goldenrod flex gap-2'>
                Learn More
        ...
        <div className=' flex justify-center mt-20'>
            <img 
            src={hero2}
            className=' w-[750px] rounded-[200px]'
            alt='hero'
            />
        </div>
    </div>
